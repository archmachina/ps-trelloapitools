...
Invoke-BuildStage -Name "Build" -Filters $Stages -Script {
    ...
    Install-PSModuleFromManifest -ManifestPath source/Noveris.TrelloApi/Noveris.TrelloApi.psd1

    # Test the module manifest
    Write-Information "Testing module manifest"
    Test-ModuleManifest source/Noveris.TrelloApi/Noveris.TrelloApi.psd1

    # Import modules as test
    Write-Information "Importing module"
    Import-Module ./source/Noveris.TrelloApi/Noveris.TrelloApi.psm1
}
